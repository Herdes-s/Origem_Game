...
// sobrando) e aba "Secundários" (Precisão e Peso). Controlado de fora
// (open/onClose) — quem abre é o GameMenu, não um botão próprio.
function StatusPanel({ open, onClose, attributes, progress, onAllocate }: Props) {
